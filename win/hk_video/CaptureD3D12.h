...
namespace tc
{
	...
	typedef HRESULT(APIENTRY* FUNC_Present) (IDXGISwapChain* pSwapChain, UINT SyncInterval, UINT Flags);
	static FUNC_Present origin_Present = NULL;

	typedef HRESULT (*FUNC_ResizeBuffers)(
	...
	static FUNC_ResizeBuffers origin_ResizeBuffers = NULL;
	...
	typedef void(APIENTRY* FUNC_ExecuteCommandLists)(ID3D12CommandQueue* queue, UINT NumCommandLists, ID3D12CommandList* ppCommandLists);
	static FUNC_ExecuteCommandLists origin_ExecuteCommandLists = NULL;

	typedef HRESULT(*FUNC_CreateCommandList)(
		ID3D12Device* Device,
		UINT nodeMask,
		...
		REFIID riid,
		void** ppCommandList);
	static FUNC_CreateCommandList origin_CreateCommandList = NULL;
	...
	private:
		...
		tc::HookApi api_Present;
		tc::HookApi api_ResizeBuffers;
		tc::HookApi api_ExecuteCommandLists;
		tc::HookApi api_CreateCommandList;
	};
